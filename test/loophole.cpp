...
TEST_CASE("general use-case for the loophole mechanism", "[loophole]")
{
    ...
    /**
     * Test whether a simple struct can be automatically reflected using the loophole
     ...
     * can be automatically reflected with the loophole mechanism.
     * @since 1.0
     */
     ...
     * object with the loophole mechanism.
     * @since 1.0
     */
